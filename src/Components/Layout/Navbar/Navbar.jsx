...
drop-shadow-md sticky top-0 left-0 z-50">
  ...
  <div className="navbar-end">
    ...
    <li className=" font-semibold text-base"><Link to="/">Login</Link></li>/
    <li className=" font-semibold text-base"><Link to="/">Signup</Link></li>
    </ul>
 



  <button className="btn btn-active bg-[#CEAF83] xl:w-32 h-14 lg:w-32 h-14 md:w-32 h-14 sm:w-7 h-5 w-24 h-20 text-white font-bold rounded-full">Reservation</button>
  </div>
</div>
        </div>
    );
